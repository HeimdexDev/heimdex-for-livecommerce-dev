...
class TestReembedMigration:
    ...
    def test_index_version_is_v4(self):
        """INDEX_VERSION should be v4 after adding content_type field."""
        assert SceneSearchClient.INDEX_VERSION == "v4"
    ...
    def test_scene_client_index_name_v4(self, mock_settings, mock_get_client):
        """SceneSearchClient should construct v4 index name."""
        settings = MagicMock()
        ...
        assert client.index_name == "heimdex_scenes_v4"
