...
class Settings(BaseSettings):
    ...
    # Dev-only: 정적으로 시드된 wizard parent/children의 progress_pct를
    # 시작 시각으로부터의 elapsed에 비례해서 응답 시점에 덮어쓴다.
    # GET /api/shorts/auto/scan-orders/{parent_job_id} 응답만 영향.
    # 워커가 없어도 progress bar가 자연스럽게 변하는 mock UX를 제공한다.
    mock_wizard_auto_progress: bool = False
