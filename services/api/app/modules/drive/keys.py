...
def thumbnail_s3_key(org_id: str, drive_id: str, google_file_id: str, scene_id: str) -> str:
    return f"{org_id}/drive/{drive_id}/{google_file_id}/thumbs/{scene_id}.jpg"


def thumbnail_s3_prefix(org_id: str, drive_id: str, google_file_id: str) -> str:
    return f"{org_id}/drive/{drive_id}/{google_file_id}/thumbs/"
