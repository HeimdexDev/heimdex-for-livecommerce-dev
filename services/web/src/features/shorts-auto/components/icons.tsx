// Local inline SVG icons — matches the per-feature icon pattern used by
// shorts-editor, shorts, and saved shorts. Keeps the feature
// self-contained and avoids pulling in an icon library.

export function MagicWandIcon({ className = "h-5 w-5" }: { className?: string }) {
  return (
