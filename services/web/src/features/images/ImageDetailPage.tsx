        ...
        <div className="space-y-4">
          ...
          {scene && (
            <>
              ...
              {(scene.keyword_tags.length > 0 || (scene.ai_tags ?? []).length > 0) && (
                <div className="rounded-xl bg-white p-5 shadow-sm">
                  ...
                  <div className="mt-1.5 flex flex-wrap gap-1.5">
                    ...
                    {(scene.ai_tags ?? []).map((tag) => (
                      <span key={`ai-${tag}`} className="rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs text-emerald-700">
                        {tag}
                      </span>
                    ))}
                  </div>
